  ...
  <div>
    ...
    <nav class="sidebar-nav scroll-sidebar" data-simplebar="">
      <ul id="sidebarnav">
        ...
        <li class="sidebar-item">
          <a class="sidebar-link" href="universidades/universidad.php" target="base" aria-expanded="false">
            <span>
              <i class="ti ti-article"></i>
            </span>
            <span class="hide-menu">Universidades</span>
          </a>
          <a class="sidebar-link" href="carreras/carrera.php" target="base" aria-expanded="false">
            <span>
              <i class="ti ti-article"></i>
            </span>
            <span class="hide-menu">Carreras</span>
          </a>
          <a class="sidebar-link" href="alumnos/alumnos.php" target="base" aria-expanded="false">
            <span>
              <i class="ti ti-article"></i>
            </span>
